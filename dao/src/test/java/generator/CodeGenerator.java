...
public class CodeGenerator {
    //JDBC配置
	private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/courier_test";
	private static final String JDBC_USERNAME = "qiandaxian";
	private static final String JDBC_PASSWORD = "qiandaxian";
	private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.cj.jdbc.Driver";

    private static final String PROJECT_PATH = System.getProperty("user.dir");//项目在硬盘上的基础路径
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/src/test/resources/generator/template";//模板位置

    private static final String JAVA_PATH = "/dao/src/main/java"; //java文件路径
    private static final String RESOURCES_PATH = "/dao/src/main/resources";//资源文件路径

    private static final String PACKAGE_PATH_VO = packageConvertPath(MODEL_VO_PACKAGE);//生成的vo存放路径
    private static final String PACKAGE_PATH_SERVICE = packageConvertPath(SERVICE_PACKAGE);//生成的Service存放路径
    private static final String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath(SERVICE_IMPL_PACKAGE);//生成的Service实现存放路径
    private static final String PACKAGE_PATH_CONTROLLER = packageConvertPath(CONTROLLER_PACKAGE);//生成的Controller存放路径

    private static final String AUTHOR = "qiandaxian";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
    	genCode("apiconfig","user");
    }
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("commonsPackage", COMMONS_PACKAGE);
